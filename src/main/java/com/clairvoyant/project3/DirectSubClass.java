...
public class DirectSubClass extends Public {
  /*
   * Defining this constructor returns error:
   * - There is no parameterless constructor available in com.clairvoyant.project2.Public
   * - Because there are another constructor on class Public but doesn't match with DirectSubClass()
   *
   * DirectSubClass() {
   *   super(); -> Error: Public() is not public in com.clairvoyant.project2.Public
   * }
   */
...
//  }
  ...
  public static void main(String[] args) {
    ...
    var h = new com.clairvoyant.project2.DirectSubClass();
    ...
    var i = new com.clairvoyant.project2.IndirectSubClass();
    ...
    var j = new com.clairvoyant.project2.AnotherIndirectSubClass1();
    ...
    var k = new com.clairvoyant.project2.AnotherIndirectSubClass2();
    ...
    var l = new com.clairvoyant.project2.AnotherIndirectSubClass3();
    ...
    var m = new com.clairvoyant.project2.AnotherIndirectSubClass4();
